...
type OrderUsecase interface {
	OnCreateOrder(c *fiber.Ctx, ctx context.Context, bankId int64, orderDatReq *_orderEntities.OrderCreate, filesDatReq []*_fileEntities.FileUploaderReq, orderProductsReq []*_orderProductEntities.OrderProductCreateReq) (*_orderDtos.OrderBanksFilesRes, int, error)
